                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="form-group row mb-0">
                      ...
                      <a href="{{ route('cars.edit', $car->id) }}" class="btn btn-info" title="Edit">Edit<i class="fa fa-edit"></i></a>
                          <a href="{{ route('cars.destroy', $car->id) }}" class="btn-delete btn btn-outline-danger" title="Delete">Delete<i class="fa fa-times"></i></a>
